...
Hinweis: der open und close Tag für Ersetzungen kann in der config.inc.php editiert werden. (siehe https://github.com/nightstomp/rex_opf_lang/blob/master/config.inc.php#L28)
